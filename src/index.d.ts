 ...
 *
 * ```javascript
 * import snap from 'electron-installer-snap'
 *
 * const snapPath = await snap(options)
 * console.log(`Created snap at ${snapPath}!`)
 * ```
 *
 * Full example with [Electron Packager](https://github.com/electron/packager):
 *
 * ```javascript
 ...
 */
declare function createSnap(userSupplied: SnapcraftOptions & CustomSnapcraftConfig): Promise<string>;
